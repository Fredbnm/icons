...
@Component({
  ...
  template: `<svg
    ...
    >
        ...
        <path
          d="M7.5 12C7.08579 12 6.75 12.3358 6.75 12.75C6.75 13.1642 7.08579 13.5 7.5 13.5H16.5C16.9142 13.5 17.25 13.1642 17.25 12.75C17.25 12.3358 16.9142 12 16.5 12H7.5Z"
          [attr.fill]="color"
        />
        <path
...
export class DropdownIconComponent implements IconProps {
