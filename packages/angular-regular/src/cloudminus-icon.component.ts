...
@Component({
  ...
  template: `<svg
    ...
    >
        ...
        />
        <path
          d="M8.25 13C8.25 12.5858 8.58579 12.25 9 12.25H14C14.4142 12.25 14.75 12.5858 14.75 13C14.75 13.4142 14.4142 13.75 14 13.75H9C8.58579 13.75 8.25 13.4142 8.25 13Z"
          [attr.fill]="color"
        />
...
export class CloudMinusIconComponent implements IconProps {
